...
Camera::Camera(XMVECTOR* position, XMVECTOR* forward, XMVECTOR* up, float inMoveSpeed, float inRotationSpeed) : ObjectTransform(true, position, forward, up, inMoveSpeed, inRotationSpeed)
{
