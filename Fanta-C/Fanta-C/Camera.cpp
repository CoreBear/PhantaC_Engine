...
Camera::Camera(XMVECTOR* position, XMVECTOR* forward, XMVECTOR* up, float inMoveSpeed, float inRotationSpeed) : MoveableObject(true, position, forward, up, inMoveSpeed, inRotationSpeed)
{
